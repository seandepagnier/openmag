...
// I/O port. The detect signal if defined sets the io connected to the 1.5k
// resistor.  The following macros define the port letter and the input
// bit numbers:
#define	USBTINY_PORT			D
#define	USBTINY_DPLUS			2
#define	USBTINY_DMINUS			4
#define USBTINY_DETECT                  3
...
#define	USBTINY_VENDOR_ID		0x16c0
#define	USBTINY_DEVICE_ID		0x05dc

// The version of the device as a 16-bit number: 256*major + minor.
#define	USBTINY_DEVICE_VERSION		0x0001
...
#define	USBTINY_VENDOR_NAME		"www.fischl.de"
#define	USBTINY_DEVICE_NAME		"USBasp"
