...
void init_gltiny(void)
{
   void *buffers[] = {framebuffer};
   gl_context = ostgl_create_context(WIDTH, HEIGHT, 16, buffers, 1);
...
void draw_gltinystuff(void)
{
  ...
  glFlush();
   ...
   glBegin( GL_LINES );
   glVertex3f(  1.0,  0.0, -0.4 );   glVertex3f(  1.0,  0.5, 0.4 );
